...
folders = glob.glob("/home/users/p/philipm/rtk/images3/*") #il faut donner le dossier dans lequel se trouve les autres dossiers avec images ou les images seulement
